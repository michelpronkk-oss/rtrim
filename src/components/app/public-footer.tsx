      ...
      <div className="mx-auto" style={{ maxWidth: 1240, padding: "0 clamp(20px,4vw,40px)" }}>
        <div className="py-10 sm:py-12 grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-10 items-start">
          <div>
            ...
            <div
              className="mt-4 inline-flex items-center gap-2 rounded-[8px] px-3 py-2.5"
              style={{ background: "#0c0e11", border: "1px solid rgba(255,255,255,0.10)" }}
            >
              <span style={{ ...MONO, fontSize: 11, color: "#a78bfa", flexShrink: 0 }}>$</span>
              <code style={{ ...MONO, fontSize: 11, color: "#c9ccd2" }}>npm install -g runtrim</code>
            </div>

            <Link
              href="/status"
              className="mt-4 inline-flex items-center gap-2 transition-colors hover:border-[rgba(110,231,183,0.35)] hover:bg-[rgba(110,231,183,0.06)]"
              style={{
                ...MONO,
                fontSize: 11,
                color: "#8fa39b",
